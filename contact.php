...
?>
    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Blood Donation Camp &amp; <br>Lahore Garrision University, <br>
					DHA ,phase 6,<br>
					Sector C.<br>
					
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone"></abbr> +92-331-460089</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email"></abbr> <a href="#" >saddi.buddy@gmail.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours"></abbr> 24*7</p>
				<p><i class="fa fa-globe"></i> 
                    <abbr title="Website"></abbr> <a href="index.php">www.commingsoon.com</a></p>
